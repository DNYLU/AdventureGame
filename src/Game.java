...
public class Game {
    ...
    public void start() {
        ...
        System.out.print("\nYou have lost your way in a dark forest in a heavy storm. When suddenly see a giant manor" +
                " on top of the hill.\nYou make the way to the manor, but when you enter the manor, the door shuts" +
